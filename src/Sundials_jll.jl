...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Sundials_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fb77eaff-e24c-56d4-86b1-d163f2edb164"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Sundials", artifacts_toml) for e in artifacts["Sundials"]]
...
if best_platform === nothing
    @debug("Unable to load Sundials; unsupported platform $(triplet(platform_key_abi()))")
else
