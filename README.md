...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/4a2f653533307ba825e77b2b1d8b859342ffd25a/S/Sundials/Sundials@6/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/LLNL/sundials/releases/download/v6.6.0/sundials-6.6.0.tar.gz (SHA256 checksum: `f90029b8da846c8faff5530fd1fa4847079188d040554f55c1d5d1e04743d29d`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/4a2f653533307ba825e77b2b1d8b859342ffd25a/S/Sundials/Sundials@6/bundled)
