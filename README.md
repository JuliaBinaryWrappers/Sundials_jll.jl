...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/dcc3cf0dda24759430d846dbe9d41bea3b37518d/S/Sundials/Sundials@5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/LLNL/sundials.git (revision: `8264ba5614fd9578786e5e8a3ba9f703ff795361`)
* files in directory, relative to originating `build_tarballs.jl`: [`../bundled@5`](https://github.com/JuliaPackaging/Yggdrasil/tree/dcc3cf0dda24759430d846dbe9d41bea3b37518d/S/Sundials/Sundials@5/bundled@5)
